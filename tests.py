...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI = 'mysql://wwwdata:secret@localhost/idea_test'
        )
        return app
    ...
    def setUp(self):
        ...
        user = User(username="user", password="pass2018")
...
class TestModels(TestBase):
    ...
    def test_department_model(self):
        ...
        # create test group
        group = Group(name="Boys Test", description="The Boys Test Group")
    ...
    def test_role_model(self):
        ...
        # create test role
        role = Role(name="BOSS", description="The Man in Charge")
